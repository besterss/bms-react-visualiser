import{S as e}from"./index-D9OIfOMg.js";import"./logDepthDeclaration-BkYTC0MN.js";import"./helperFunctions-DoOmqX0f.js";const o="decalFragmentDeclaration",X=`#ifdef DECAL
...
#endif
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=M);const f="lightUboDeclaration",O=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
result.Diffuse=LTCEvaluate( normal,viewDir,position,mat3( 1.0 ),rectCoords );return result;}`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=y);const s="lightsFragmentFunctions",_=`struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
#endif
...
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=_);const d="shadowsFragmentFunctions",b=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=b);const c="samplerFragmentDeclaration",U=`#ifdef _DEFINENAME_
...
{discard;}
#endif
`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=$);const D="bumpFragment",Z=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[D]||(e.IncludesShadersStore[D]=Z);const L="decalFragment",q=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;e.IncludesShadersStore[L]||(e.IncludesShadersStore[L]=q);const I="depthPrePass",Q=`#ifdef DEPTHPREPASS
